  ...
  <div class="page pu">
    <PageHeader title="Cartera de Préstamos" />
      <div v-if="report" class="kpi-grid">
        <KPI label="Cartera Total" :value="formatCurrency(report.totalCapital)" :goldValue="true" />
        <KPI label="Activos" :value="report.activeLoans || 0" :goldValue="true" />
        <KPI label="En Mora" :value="report.defaultedLoans || 0" :goldValue="true" />
      </div>
